...
SELECT R.REVIEW_NUM, R.REVIEW_CONTENT, R.REVIEW_REGISTRATION_DATE, R.REVIEW_STAR, COALESCE(R.REVIEW_WRITER_ID,'탈퇴한 회원입니다.'), COALESCE(M.MEMBER_NICKNAME,'탈퇴한 회원입니다.'), M.MEMBER_PROFILE
FROM REVIEW R
