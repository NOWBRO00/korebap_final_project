...
SELECT * FROM REPLY;
-- 샘플 데이터
INSERT INTO REPLY (REPLY_NUM,REPLY_CONTENT,REPLY_WRITER_ID,REPLY_REGISTRATION_DATE,REPLY_BOARD_NUM) VALUES (NVL((SELECT MAX(REPLY_NUM) FROM REPLY),0)+1,'ㅎㅇㅎㅇ','MOOGUN3852@naver.com',SYSDATE,0,1);
INSERT INTO REPLY (REPLY_NUM,REPLY_CONTENT,REPLY_WRITER_ID,REPLY_REGISTRATION_DATE,REPLY_BOARD_NUM) VALUES (NVL((SELECT MAX(REPLY_NUM) FROM REPLY),0)+1,'ㅎㅇㅎㅇ','wlsrja3852@naver.com',SYSDATE,0,3);
INSERT INTO REPLY (REPLY_NUM,REPLY_CONTENT,REPLY_WRITER_ID,REPLY_REGISTRATION_DATE,REPLY_BOARD_NUM) VALUES (NVL((SELECT MAX(REPLY_NUM) FROM REPLY),0)+1,'반가워요','wlsrja3852@naver.com',SYSDATE,0,1);
INSERT INTO REPLY (REPLY_NUM,REPLY_CONTENT,REPLY_WRITER_ID,REPLY_REGISTRATION_DATE,REPLY_BOARD_NUM) VALUES (NVL((SELECT MAX(REPLY_NUM) FROM REPLY),0)+1,'대박','tlsektha3852@naver.com',SYSDATE,0,2);
INSERT INTO REPLY (REPLY_NUM,REPLY_CONTENT,REPLY_WRITER_ID,REPLY_REGISTRATION_DATE,REPLY_BOARD_NUM) VALUES (NVL((SELECT MAX(REPLY_NUM) FROM REPLY),0)+1,'비공개임','tlsektha3852@naver.com',SYSDATE,1,2);
INSERT INTO REPLY (REPLY_NUM,REPLY_CONTENT,REPLY_WRITER_ID,REPLY_BOARD_NUM) VALUES (NVL((SELECT MAX(REPLY_NUM) FROM REPLY),0)+1,'날이 추워지면.. 방어','tlsektha3852@naver.com',0,9);
...
INSERT INTO REPLY (REPLY_NUM,REPLY_CONTENT,REPLY_WRITER_ID,REPLY_BOARD_NUM) 
...
SELECT R.REPLY_NUM,R.REPLY_CONTENT,R.REPLY_WRITER_ID, M.MEMBER_NICKNAME ,R.REPLY_REGISTRATION_DATE, M.MEMBER_PROFILE
FROM REPLY R
