					...
					<div class="nav-menu">
						<nav class="mainmenu">
							<ul>
								...
								<li><a href="ownerProductList.do">상품 관리</a>
									<ul class="dropdown">
										<li><a href="ownerProductList.do">내 상품 관리</a></li>
									</ul></li>
								<li><a href="ownerReservationList.do">예약 관리</a>
									<ul class="dropdown">
										<li><a href="ownerReservationList.do">상품 예약 내역</a></li>
									</ul></li>
								<li>
									<!-- 검색창 포함 -->
