...
<body>
            ...
            <div class="col-lg-6">
		        ...
		        <div class="weather-box mt-5" style="text-align:center">
					...
					<div style="display: flex; align-items: center; justify-content:center">
					    <img class="weather_Icon" src="" alt="Weather Icon" style="width: 50px; height: 50px; margin-right: 10px;"/>
					    <div class="weather_Info" style="font-size: 20px; color: #555;"></div>
					    <input type="hidden" id="product_address" value="${product.product_address}">
					</div>
		    	</div>
            </div>
   ...
   <script src="js/product/mapNweather.js"></script>
	...
	<script>
		...
		var product_data = {
			address : '${product.product_address}'
		};
